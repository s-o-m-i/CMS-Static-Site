                ...
                <Slider {...settings}>
                    <div>
                        <div className="w-[90%] mx-auto text-center">
                            <p className='text-[#585858]'>“They have the most updated knowledge and skill set in the digital market.”</p>
                    ...
                    <div>
                        <div className="w-[90%] mx-auto text-center">
                            <p className='text-[#585858]'>“Conveying the right balance between expert design and marketing skills, Webistry has earned their client&rsquo;s trust by generating high-yielding branding solutions that have resulted in an increased conversion rate.”</p>
                    ...
                    <div>
                        <div className="w-[90%] mx-auto text-center">
                            <p className='text-[#585858]'>“The team at Webistry delivers high-quality work quickly. They’re flexible and handle limitations or restrictions in stride.”</p>
                    ...
                    <div>
                        <div className="w-[90%] mx-auto text-center">
                            <p className='text-[#585858]'>“Fantastic agency! The Webistry team is highly knowledgeable about all things digital and marketing and they are a great resource for any stage web startup/company. The founders Stefano & Jonathan are super awesome and pleasant to work with and come with years of expertise.”</p>
                    ...
                    <div>
                        <div className="w-[90%] mx-auto text-center">
                            <p className='text-[#585858]'>“These guys are worth every penny. Excellent results (very high CVRs, good CPA, [and] lots of new customers!). The Webistry co-founders are hands-on, creative, and keep tweaking throughout. Their attentiveness to the campaigns and my crazy ideas have exceeded my expectations month after month.”</p>
